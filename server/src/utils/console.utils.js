...
// export const logBlack = (message) => {
//     console.log(`\x1b[30m%s\x1b[0m`, message)
// }

// export const logRed = (message) => {
//     console.log(`\x1b[31m%s\x1b[0m`, message)
// }

// export const logGreen = (message) => {
//     console.log(`\x1b[32m%s\x1b[0m`, message)
// }

// export const logYellow = (message) => {
//     console.log(`\x1b[33m%s\x1b[0m`, message)
// }
...
// export const logCyan = (message) => {
//     console.log(`\x1b[36m%s\x1b[0m`, message)
// }

// export const logWhite = (message) => {
//     console.log(`\x1b[37m%s\x1b[0m`, message)
// }
